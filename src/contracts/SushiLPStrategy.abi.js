module.exports = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_rewardToken1', type: 'address' },
      { internalType: 'address', name: '_rewardToken2', type: 'address' },
  ...
  {
    inputs: [{ internalType: 'address', name: 'arbiAddress', type: 'address' }],
    name: 'setArbi',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
