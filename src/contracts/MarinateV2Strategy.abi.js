module.exports = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_marinateContract', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: 'swapRoute', type: 'bytes' },
    ],
    name: 'addRewardToken',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'contract IMarinateV2', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
